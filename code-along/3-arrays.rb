...
puts favorite_foods [-1] # going backwards

puts shopping_list [1][1] # when there's an array inside the array

# Add to the array
favorite_foods.push("more tacos")
favorite_foods = favorite_foods + ["fries", "ramen"]
puts favorite_foods.inspect # the .inspect shows you what the array looks like
